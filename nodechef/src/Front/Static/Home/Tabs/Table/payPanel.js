...
async function pagar(tipoClase, precio, idClase) {              //idClase, debe ser un atributo asignado al slot de la clase (<div class="slotDeClase" data-sala="S1">)
    const res = await fetch("/api/crear-preferencia", {         //Que se asigna al cargar la tabla con datos desde la DB.
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ tipo: tipoClase, cantidad:1, precio: precio, idClase: idClase })
    });
